...
<div style="display: flex; flex-direction: row; gap: 1rem; align-items: center;">
    <img src={favicon.src} style="height: 4.2rem; image-rendering: pixelated; margin-left: -0.5rem" />
    # amrita.town
</div>
...
3. Write an email to us at [contact@amrita.town](mailto:contact@amrita.town) or for extra coolness points, send a pr to add yourself to `src/members.json` on our [github](https://github.com/amritadottown/website). feel free to tell us a little bit about yourself too!
